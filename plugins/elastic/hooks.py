...
from plugins.elastic.authors import AuthorsPlugin


logger = logging.getLogger(__name__)

_plugins = []
_plugins.append(AuthorsPlugin())
...
def on_page_markdown(
    ...
    for _p in _plugins:
        _op = getattr(_p, "on_page_markdown", None)
        if callable(_op):
            _p.on_page_markdown(markdown, page, config, files)
